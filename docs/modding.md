...
- `docs/unit-struct.md` — 48 scalars behaviorally named through CT/JP and thirteen status durations; all 63 scalar loads and six address returns structurally mapped, with 15 scalars still numeric
