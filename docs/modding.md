...
- `docs/unit-struct.md` — 35 scalars behaviorally named through CT/Speed/carry/JP; all 63 scalar loads and six address returns structurally mapped, with 28 later battle-state scalars still numeric
