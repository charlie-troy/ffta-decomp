...
- `docs/unit-struct.md` — all 69 unit-stat ids mapped to direct loads or returned addresses, including base/active/secondary job, level/EXP, HP/MaxHP, MP/MaxMP, Attack/Defense, and Magic Power/Resistance
